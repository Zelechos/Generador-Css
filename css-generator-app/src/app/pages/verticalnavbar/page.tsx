...
import Visualizador from "../visualizer/page";
      ...
      <aside id="default-sidebar" className={`fixed top-0 left-0 z-30 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 flex items-center ${isNavVisible ? "" : "hidden"}`} aria-label="Sidebar">
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <ul className="space-y-2 font-medium">
            <li>
              <a onClick={toggleVisualizerVisibility} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
              <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Inicio de Sesion</span>
              </a>
            </li>
            <li className="pb-3 sm:pb-4">
              <div className="flex items-center space-x-4 rtl:space-x-reverse inset-x-0 bottom-0 p-3 absolute">
                <div className="flex-shrink-0">
                  <img className="w-8 h-8 rounded-full" src="https://avatars.githubusercontent.com/u/41464891?s=400&u=fa86e65978d28328ff13a30223740139cb595a5e&v=4" alt="Neil image" />
                </div>
