    ...
    <button className="bg-red-600 pt-5" onClick={showNav(true)}>Toggle button</button>
      <div id="Main" className="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-gray-900 flex-col my-4">
        ...
        <div className="hidden xl:flex justify-start p-6 items-center space-x-3">
          ...
          <p className="text-2xl leading-6 text-white">Css Generator IA</p>
        </div>
        ...
        <div className="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
          <button className="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-indigo-400  text-white rounded ">
            ...
            <p className="text-base leading-4 ">Visualizer</p>
          </button>
          <button className="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-white focus:text-indigo-400   rounded ">
            ...
            <p className="text-base leading-4 ">History</p>
          </button>
        </div>
        <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  pb-6">
        ...
        <div className="flex flex-col justify-between items-center h-full pt-6 pb-6   px-6  w-full  space-y-32 ">
          ...
          <div className=" flex justify-between items-center w-full">
            <div className="flex justify-center items-center  space-x-2">
              ...
              <div className="flex justify-start flex-col items-start">
                ...
                <p className="cursor-pointer text-xs leading-3 text-gray-300">alextumirihuanca@gmail.com</p>
              </div>
            </div>
